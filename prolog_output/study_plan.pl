...
% --- 'EIFXXX' ---
course('EIFXXX').
course('EIFXXX', 31, regular, bsc, 4, 4, 1, 'Diseño y programación de plataformas Móviles').
course_req('EIFXXX', 'EIF209').
course_req('EIFXXX', 'EIF428O').
% --- 'EIF406' ---
course('EIF406').
course('EIF406', 32, regular, bsc, 4, 4, 1, 'Ingeniería de Sistemas III').
course_req('EIF406', 'EIF401').
% --- 'Optativa1' ---
course('Optativa1').
course('Optativa1', 33, regular, bsc, 3, 4, 1, 'Optativa 1').
course_req('Optativa1', 'Admission').
% --- 'Optativa2' ---
course('Optativa2').
course('Optativa2', 34, regular, bsc, 3, 4, 1, 'Optativa 2').
course_req('Optativa2', 'Admission').
% --- 'EIF403' ---
course('EIF403').
course('EIF403', 35, regular, bsc, 3, 4, 1, 'Métodos de Investigación Científica en Informática').
course_req('EIF403', 'MAY223').
% --- 'EIF408' ---
course('EIF408').
course('EIF408', 36, regular, bsc, 5, 4, 2, 'Proyectos y su Aplicación en la Organización (PPS)').
course_req('EIF408', 'EIF209').
course_req('EIF408', 'EIF401').
course_req('EIF408', 'EIF402').
% --- 'EIF409' ---
course('EIF409').
course('EIF409', 37, regular, bsc, 4, 4, 2, 'Aplicaciones Informáticas Globales').
course_req('EIF409', 'EIF209').
course_req('EIF409', 'EIF401').
course_req('EIF409', 'EIF402').
% --- 'Optativa3' ---
course('Optativa3').
course('Optativa3', 38, regular, bsc, 3, 4, 2, 'Optativa 3').
course_req('Optativa3', 'Admission').
% --- 'Optativa4' ---
course('Optativa4').
course('Optativa4', 39, regular, bsc, 3, 4, 2, 'Optativa 4').
course_req('Optativa4', 'Admission').
% --- 'EIF410' ---
course('EIF410').
course('EIF410', 40, regular, bsc, 2, 4, 2, 'Informática y Sociedad').
...
course_req('EIF100O', 'Admission').
% --- 'EIF420O' ---
course('EIF420O').
course('EIF420O', 42, optional, bsc, 3, none, none, 'Inteligencia Artificial').
course_req('EIF420O', 'EIF207').
course_req('EIF420O', 'Admission').
% --- 'EIF421O' ---
course('EIF421O').
course('EIF421O', 43, optional, bsc, 3, none, none, 'Análisis de Algoritmos').
course_req('EIF421O', 'EIF207').
course_req('EIF421O', 'MAY231').
% --- 'EIF422O' ---
course('EIF422O').
course('EIF422O', 44, optional, bsc, 3, none, none, 'Diseño de Interfaces de usuario').
course_req('EIF422O', 'EIF206').
course_req('EIF422O', 'Admission').
% --- 'EIF424O' ---
course('EIF424O').
...
% --- 'EIF425O' ---
course('EIF425O').
course('EIF425O', 46, optional, bsc, 3, none, none, 'Diseño de Ambientes Multimediales').
course_req('EIF425O', 'Admission').
% --- 'EIF426O' ---
course('EIF426O').
course('EIF426O', 47, optional, bsc, 3, none, none, 'Diseño de Ambientes de Aprendizaje').
course_req('EIF426O', 'Admission').
% --- 'EIF427O' ---
course('EIF427O').
course('EIF427O', 48, optional, bsc, 3, none, none, 'Robótica').
course_req('EIF427O', 'EIF204').
course_req('EIF427O', 'Admission').
% --- 'EIF428O' ---
course('EIF428O').
course('EIF428O', 49, optional, bsc, 3, none, none, 'Fundamentos de Programación Web').
course_req('EIF428O', 'EIF206').
course_req('EIF428O', 'EIF211').
% --- 'EIF431O' ---
course('EIF431O').
course('EIF431O', 50, optional, bsc, 3, none, none, 'Administración de servidores basados en software libre').
course_req('EIF431O', 'EIF212').
course_req('EIF431O', 'EIF402').
% --- 'EIF433O' ---
course('EIF433O').
course('EIF433O', 51, optional, bsc, 3, none, none, 'Contexto, Desarrollo y Aplicación de Software Libre y de código abierto').
course_req('EIF433O', 'EIF212').
course_req('EIF433O', 'EIF211').
% --- 'EIF434O' ---
course('EIF434O').
course('EIF434O', 52, optional, bsc, 3, none, none, 'Minería de Datos I').
course_req('EIF434O', 'EIF402').
course_req('EIF434O', 'MAY223').
% --- 'EIF435O' ---
course('EIF435O').
course('EIF435O', 53, optional, bsc, 3, none, none, 'Minería de Datos II').
course_req('EIF435O', 'EIF434').
course_req('EIF435O', 'Admission').
% --- 'EIG416O' ---
course('EIG416O').
course('EIG416O', 54, optional, bsc, 3, none, none, 'Gestión de Tecnología Educativa').
course_req('EIG416O', 'EIF425 O Diseño de ambientes multimediales').
course_req('EIG416O', 'Admission').
% --- 'EIF429O' ---
course('EIF429O').
course('EIF429O', 55, optional, bsc, 3, none, none, 'Introducción a la creación de Empresas').
course_req('EIF429O', 'Admission').
% --- 'EIF430O' ---
course('EIF430O').
course('EIF430O', 56, optional, bsc, 3, none, none, 'Las TIC’s en el Ámbito Jurídico de Costa Rica').
...
% --- 'EIG418O' ---
course('EIG418O').
course('EIG418O', 58, optional, bsc, 3, none, none, 'La organización y su entorno').
